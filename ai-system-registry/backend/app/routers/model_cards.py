...
@router.post("/model-cards", response_model=ModelCardResponse, status_code=201)
...
@router.put("/model-cards/{model_id}", response_model=ModelCardResponse)
...
@router.delete("/model-cards/{model_id}")
