...
TARGET_FIELDS: list[dict[str, str]] = [
    {
        ...
        "hint": "Is this the first time registering this AI system, or a resubmission?",
    },
    {
        "key": "external_id",
        "label": "External System ID",
        "hint": "ID in an external register or ticketing system, if applicable. Leave blank if not applicable.",
    },
    {
        "key": "use_case_owner",
        "label": "Use Case Owner",
        "hint": "Name of the person responsible for delivering this AI system end-to-end.",
    },
    {
        "key": "use_case_type",
        "label": "Type of Use Case",
        "hint": "How is this AI system developed and deployed? e.g. internal development, third-party product, customer-specific, partner-developed.",
    },
    {
        "key": "department",
        "label": "Developing Business Unit",
        "hint": "Which department, team, or line of business develops or owns this AI system?",
    },
    {
        "key": "technologies",
        "label": "Technologies Involved",
        "hint": "Main technologies, models, frameworks, or platforms used (e.g. LLMs, ML models, APIs, cloud services).",
    },
    {
        "key": "use_case_status",
        "label": "Status of AI Use Case",
        "hint": "Is this a new AI use case or does it already exist?",
    },
    {
        "key": "use_case",
        "label": "Detailed Description",
        "hint": "Describe the system: architecture overview, purpose and goals, input/output data, deployment timeline, human oversight, and development stage.",
    },
    {
        "key": "planned_modifications",
        "label": "Planned Changes (12–24 months)",
        "hint": "Any architectural or functional changes planned in the next 12–24 months? If none, write N/A.",
    },
    {
        "key": "entity_role",
        "label": "Organisation's Role",
        "hint": "Is your organisation the Provider (develops/makes available) or the Deployer (operates a third-party system for own purposes)?",
    },
    {
        "key": "additional_entity_roles",
        "label": "Additional Roles",
        "hint": "Does your organisation also act as Distributor, Importer, Authorised Representative, or Operator? Describe, or write N/A.",
    },
    {
        "key": "used_in_eu",
        "label": "Used in the EU",
        "hint": "Will this AI system be used, placed on the market, or put into service in the European Union? Answer yes or no.",
    },
    {
        "key": "exception_category",
        "label": "Exception Category",
        "hint": "Does the system fall into any category fully out of scope of the EU AI Act (e.g. military use, pure R&D, open-source)? If none, say None of the above.",
    },
    {
        "key": "sector_legislation",
        "label": "Sector-Specific Legislation",
        "hint": "Is this system part of a product regulated by existing EU sector legislation (e.g. medical devices, machinery)? If none, say None of the above.",
    },
]
...
def _field_state_block(fields: dict[str, Any]) -> str:
    ...
    for f in TARGET_FIELDS:
        ...
        lines.append(
            f"- {f['key']}: {value if value not in (None, '') else '(not set)'}"
        )
    return "\n".join(lines)
...
def build_doc_extract_messages(
    ...
    if image_b64:
        ...
        messages.append(
            {
                ...
                "content": [
                    {
                        "type": "text",
                        "text": "Extract AI system information from this document image.",
                    },
                    {
                        "type": "image_url",
                        "image_url": {
                            "url": f"data:{media_type or 'image/png'};base64,{image_b64}"
                        },
                    },
                ],
            }
        ...
        messages.append(
            {
                "role": "user",
                "content": f"Extract AI system information from this document:\n\n{parsed_text or ''}",
            }
        )
    return messages
...
ENGINEER_TARGET_FIELDS: list[dict[str, str]] = [
    {
        "key": "description",
        "label": "Description",
        "hint": "Brief technical description of the AI system.",
    },
    {
        "key": "intended_purpose",
        "label": "Intended Purpose",
        "hint": "Intended purpose and deployment context.",
    },
    {
        "key": "version",
        "label": "Version",
        "hint": "Version string, e.g. 1.0.0, 2.1, 3.0-beta.",
    },
    {
        "key": "provider",
        "label": "Provider",
        "hint": "Name of the organisation or team that built the model/system.",
    },
    {
        "key": "org_name",
        "label": "Organisation Name",
        "hint": "Legal or business name of the deploying organisation.",
    },
    {
        "key": "system_type",
        "label": "System Type",
        "hint": "One of: application, model, component, service.",
    },
    {
        "key": "lifecycle",
        "label": "Lifecycle State",
        "hint": "One of: development, testing, conformity, market.",
    },
    {
        "key": "autonomy_level",
        "label": "Autonomy Level",
        "hint": "One of: decision_support, human_in_the_loop, human_on_the_loop, fully_automated.",
    },
]
...
def build_engineer_turn_messages(
...
def build_engineer_doc_extract_messages(
    ...
    if image_b64:
        messages.append(
            {
                ...
                "content": [
                    {
                        "type": "text",
                        "text": "Extract AI system technical information from this document image.",
                    },
                    {
                        "type": "image_url",
                        "image_url": {
        ...
        messages.append(
            {
                "role": "user",
                "content": f"Extract AI system technical information from this document:\n\n{parsed_text or ''}",
            }
        )
    return messages
...
BUSINESS_QUESTIONNAIRE_FIELDS: list[dict[str, str]] = [
    {
        ...
        "hint": "What is the primary purpose of this AI system?",
    },
    {
        "key": "department",
        "label": "Owning Department",
        "hint": "Which department or business unit owns this system?",
    },
    {
        "key": "use_case",
        "label": "Use Case",
        "hint": "Describe the specific use case this system addresses.",
    },
    {
        "key": "people_affected",
        "label": "People Affected",
        "hint": "Who is affected by this system's decisions or outputs?",
    },
    {
        "key": "decision_context",
        "label": "Decision Context",
        "hint": "How are the system's outputs used in decision-making?",
    },
    {
        "key": "data_sources",
        "label": "Data Sources",
        "hint": "What data sources or inputs does the system use?",
    },
    {
        "key": "oversight_mechanism",
        "label": "Human Oversight",
        "hint": "What human oversight or review mechanisms exist?",
    },
    {
        "key": "deployment_context",
        "label": "Deployment Context",
        "hint": "Where and how is this system deployed or accessed?",
    },
]

BUSINESS_QUESTIONNAIRE_KEYS: list[str] = [
    f["key"] for f in BUSINESS_QUESTIONNAIRE_FIELDS
]
...
def _business_field_state_block(
    fields: dict[str, Any], existing_data: dict[str, Any]
) -> str:
...
def _business_target_schema_block() -> str:
    return "\n".join(
        f"- {f['key']} — {f['hint']}" for f in BUSINESS_QUESTIONNAIRE_FIELDS
    )


def _technical_field_state_block(
    fields: dict[str, Any], existing_flags: dict[str, Any]
) -> str:
    ...
    for flag in _FLAG_NAMES:
        ...
        lines.append(
            f"- {flag} ({label}): {value if value is not None else '(not set)'}"
        )
    return "\n".join(lines)
