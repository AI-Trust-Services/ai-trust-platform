...
export const TIER_META: Record<TierKey, { label: string; cls: string }> = {
  ...
  "limited":       { label: "Limited or No Risk AI System", cls: "badge-limited" },
  "minimal":       { label: "Limited or No Risk AI System", cls: "badge-minimal" },
...
export const LIFECYCLE_LABELS: Record<LifecycleKey, string> = {
  ...
  "testing":        "Testing",
  "conformity":     "Production Ready",
  "market":         "On Market",
  "post-market":    "In Service",
