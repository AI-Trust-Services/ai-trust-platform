// ISO 3166-1 alpha-2 country list for the registration deployment-country dropdown.
// Sorted alphabetically by name. EU member states are flagged so the form can (later)
// surface country-specific questions; the two universal EU-presence questions are asked
// for every country regardless of this flag.
...
export const COUNTRIES: Country[] = [
  ...
  { code: "CG", name: "Congo (Republic)", eu: false },
  { code: "CD", name: "Congo (DRC)", eu: false },
  ...
  { code: "ST", name: "São Tomé and Príncipe", eu: false },
  ...
  { code: "VA", name: "Vatican City", eu: false },
