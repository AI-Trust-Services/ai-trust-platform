...
_SEED_MODEL_CARDS = [
    ...
    (
        ...
        "2402",
        "llm",
        "Mistral AI large model — strong reasoning",
        False,
    ...
    (
        ...
        "0.3",
        "llm",
        "Mistral 7B open-weights instruction model",
        True,
        "",
    ),
    (
        ...
        "3.0",
        "llm",
        "Meta Llama 3 70B open-weights model",
        True,
        "",
    ),
    (
        ...
        "3.0",
        "llm",
        "Meta Llama 3 8B open-weights model",
        True,
        "",
    ),
    (
        ...
        "0.1",
        "llm",
        "Mistral Mixtral MoE open-weights model",
        True,
        "",
    ),
    (
        ...
        "1",
        "embedding",
        "OpenAI large text embedding model",
        False,
        "https://api.openai.com/v1",
    ),
    (
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "system_type", sa.String(30), nullable=False, server_default="application"
        ),
        sa.Column(
            "autonomy_level",
            sa.String(50),
            nullable=False,
            server_default="decision_support",
        ),
        sa.Column("application_url", sa.String(500), nullable=False, server_default=""),
        sa.Column(
            "provider_country", sa.String(5), nullable=False, server_default="DE"
        ),
        ...
        sa.Column(
            "lifecycle", sa.String(30), nullable=False, server_default="development"
        ),
        sa.Column("compliance", sa.Float, nullable=False, server_default="0"),
        sa.Column(
            "model_id",
            sa.String(20),
            sa.ForeignKey("model_cards.id", ondelete="SET NULL"),
            nullable=True,
        ),
        sa.Column(
        ...
        sa.Column(
            "exploits_vulnerability", sa.Boolean, nullable=False, server_default="false"
        ),
        sa.Column(
            "social_scoring_public", sa.Boolean, nullable=False, server_default="false"
        ),
        sa.Column(
        ...
        sa.Column(
            "predictive_policing", sa.Boolean, nullable=False, server_default="false"
        ),
        sa.Column(
        ...
        sa.Column(
            "is_education_related", sa.Boolean, nullable=False, server_default="false"
        ),
        sa.Column(
            "is_employment_related", sa.Boolean, nullable=False, server_default="false"
        ),
        sa.Column(
            "is_credit_scoring", sa.Boolean, nullable=False, server_default="false"
        ),
        sa.Column(
            "is_public_service", sa.Boolean, nullable=False, server_default="false"
        ),
        sa.Column(
            "is_law_enforcement", sa.Boolean, nullable=False, server_default="false"
        ),
        sa.Column("is_migration", sa.Boolean, nullable=False, server_default="false"),
        sa.Column(
            "is_judicial_admin", sa.Boolean, nullable=False, server_default="false"
        ),
        sa.Column("is_gpai", sa.Boolean, nullable=False, server_default="false"),
        sa.Column(
            "training_compute_flops", sa.Float, nullable=False, server_default="0"
        ),
