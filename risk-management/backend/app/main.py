...
from app.routers import registers, risks, triggers, test_reports, plan_tasks, incidents, registry_proxy, risk_library
...
app.include_router(risk_library.router, prefix="/v1")
