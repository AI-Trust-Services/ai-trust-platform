    ...
    "Art. 50(1)": [
        {
            "slug": "AISEC-TR-002",
            "category": "documentation",
            "risk_category": "Limited-Risk; High-Risk",
...
def requirements_for(article_ref: str, tier: str) -> list[dict]:
    ...
    return [
        t
        for t in _REQUIREMENT_TEMPLATES.get(article_ref, [])
        if _tier_allows(t["risk_category"], tier)
    ]
