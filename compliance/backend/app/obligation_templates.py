...
_EU_HIGH_RISK = [
    ...
    {
        "title": "Conduct fundamental rights impact assessment (public bodies)",
        "article_ref": "Art. 27",
...
_ISO = [
    {
        "title": "Understand organisational context (Clause 4)",
        "article_ref": "Clause 4",
...
def obligations_for(
    framework_id: str, tier: str, org_role: str = "provider"
) -> list[dict]:
