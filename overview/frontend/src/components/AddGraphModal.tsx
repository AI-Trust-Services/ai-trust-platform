...
const REGISTRY_CHARTS: RecommendedChart[] = [
  ...
  { id: "chart_by_model_validation", title: "Models by Validation Status", desc: "Validated vs. unvalidated models", type: "bar",   dataKey: "by_model_validation_status", badge: "Bar"   },
